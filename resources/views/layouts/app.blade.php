    ...
    <div class="sidebar py-3 px-2 flex-shrink-0">
        ...
        <ul class="nav flex-column">
            ...
            @if (Auth::user()->role === 'admin')
                <li class="nav-item">
                    <a href="{{ route('admin.dashboard') }}" class="nav-link active"><i class="bi bi-speedometer2"></i>
                        Dashboard</a>
                </li>
                ...
                <li class="nav-item">
                    <a href="{{ route('categories.index') }}" class="nav-link"><i class="bi bi-tags"></i> Kategori</a>
                </li>
                <li class="nav-item">
                    <a href="{{ route('users.index') }}" class="nav-link"><i class="bi bi-people"></i> Data User</a>
                </li>
            @endif
